...
export default function App() {
  ...
  function editCompanyDoc(doc: CompanyDoc) { setEditingCompanyDocId(doc.id); setCompanyDraft({ ...doc }) }
  function resetCompanyDocForm() { setEditingCompanyDocId(''); setCompanyDraft(emptyCompanyDoc(currentUserId)) }
