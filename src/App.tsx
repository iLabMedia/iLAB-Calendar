...
type ViewMode = 'calendar' | 'month' | 'today' | 'week' | 'team' | 'mine' | 'project' | 'company'
...
export default function App() {
  ...
  return <main className="appShell">
    ...
    <nav className="viewTabs"><button className={view === 'calendar' ? 'active' : ''} onClick={() => setView('calendar')}>주간 캘린더</button><button className={view === 'project' ? 'active' : ''} onClick={() => setView('project')}>프로젝트</button><button className={view === 'today' ? 'active' : ''} onClick={() => setView('today')}>오늘</button><button className={view === 'team' ? 'active' : ''} onClick={() => setView('team')}>팀별</button><button className={view === 'mine' ? 'active' : ''} onClick={() => setView('mine')}>내일정</button><button className={view === 'month' ? 'active' : ''} onClick={() => setView('month')}>월간 캘린더</button><button className={view === 'company' ? 'active' : ''} onClick={() => setView('company')}>회사정보</button></nav>
